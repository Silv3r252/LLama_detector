...
def get_cfg(output_dir, learning_rate, batch_size, iterations, checkpoint_period, model, device, nmr_classes,numberworker,resume,checkpoint):
    """
    ...
    cfg.DATALOADER.NUM_WORKERS = numberworker
...
def train(output_dir, data_dir, class_list_file, learning_rate, batch_size, iterations, checkpoint_period, device,
          model,resume,num_worker,checkpoint):
    """
    ...
    cfg = get_cfg(output_dir, learning_rate, batch_size, iterations, checkpoint_period, model, device, nmr_classes,num_worker,resume,checkpoint)
